...
function buildWebpackConfig(root, config, baseWebpackConfig, options, context) {
    ...
    const customWebpackConfig = config ? require(`${core_1.getSystemPath(root)}/${config}`) : {};
    const mergedConfig = webpackMerge.smart(baseWebpackConfig, singleSpaConfig, customWebpackConfig);
...
//# sourceMappingURL=single-spa-webpack-builder.js.map