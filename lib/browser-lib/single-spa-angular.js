  ...
  return Promise.resolve()
    ...
    .then(function() {
      ...
      if (!(bootstrapPromise instanceof Promise)) {
        throw Error(
          "single-spa-angular: the opts.bootstrapFunction must return a promise, but instead returned a '" +
            typeof bootstrapPromise +
      ...
      return bootstrapPromise.then(function(module) {
        ...
        return opts.bootstrappedModule;
      });
    });
}
...
function unmount(opts, props) {
  return Promise.resolve().then(function() {
    // if (!opts.bootstrappedModule.destroyed) {
